...
// const [ headerOpen, openHeader ] = useState(false)
...
function App() {
	...
	// 		dispatch({type : 'TOGGLE_HEADER', payload : { userName : userName }})
	//
	// 		// this.setState({
...
ReactDOM.render(<StateProvider><App /></StateProvider>, document.getElementById('app'));
